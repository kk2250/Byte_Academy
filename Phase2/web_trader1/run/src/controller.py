...
app = Flask(__name__)
app.secret_key = 'any randomadlfjasd;f strinasdofijsdifjg'
...
@app.route('/admin/lookup_quote',methods=['GET','POST'])
def admin_lookup():
    if request.method == 'GET':
...
@app.route('/loggin_new',methods=['GET','POST'])
def log_in_new():
    if request.method == 'GET':
...
@app.route('/web_trader',methods=['GET','POST'])
def main_page():
    if request.method == 'GET':
...
@app.route('/lookup_quote',methods=['GET','POST'])
def lookup_quote():
    if request.method == 'GET':
